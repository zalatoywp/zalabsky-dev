            ...
            <div className="mx-auto max-w-7xl py-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="relative isolate overflow-hidden bg-gray-800 px-3 sm:px-16 py-4 sm:py-24 text-center shadow-md sm:rounded-3xl">
                    <div className="mx-auto max-w-7xl">
                        ...
                        <div>
                            <div className="text-3xl font-bold text-orange-800 sm:text-6xl mb-3 text-center">
                                Zalabsky Dev Tools
                            </div>
                            <div className="text-3xl font-bold text-gray-200 sm:text-4xl text-center">
                                Eliminar Registros Antiguos
                            </div>
                            <p className="mt-4 text-lg leading-6 text-gray-200 text-center">
                                Limpiar publicaciones antiguas, likes y reposts de tu
                                cuenta de Bluesky
                            </p>
                        </div>
                        <form
                        ...
                        >
                            <div className="grid w-full max-w-md">
                                ...
                                <div className="grid grid-cols-1 sm:flex-auto">
                                    <input
                                        ...
                                        placeholder="Introduce el Email, Handle, o DID"
                                        value={identifier}
                            ...
                            <div className="grid w-full max-w-md mt-3">
                                ...
                                <div className="grid grid-cols-1 sm:flex-auto">
                                    <input
                                        ...
                                        id="appPass"
                                        className="peer relative col-start-1 row-start-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="Introduzca su App Password"
                                        value={appPass}
                                ...
                                <div className="text-left">
                                    <span className="text-xs text-orange-200">
                                        Obtenga un nuevo{" "}
                                        <a
                                            className="underline text-indigo-200 hover:text-indigo-500"
                                            target="_blank"
                                            href="https://bsky.app/settings/app-passwords"
                                        >
                                            App Password aquí
                                        </a>{" "}
                                        y elimínelo una vez que su trabajo haya terminado de ejecutarse
                                    </span>
                                </div>
                            </div>
                            ...
                            <br></br>
                            <div className="py-4 px-6 border-2  border-red-950 shadow-md   shadow-red-500/50 bg-red-400/5 rounded-lg">
                                <div className="mt-3 text-sm w-full leading-7 text-gray-100 px-4 text-justify">
                                    <p className="text-2xl bg-red-300 rounded-lg font-bold underline text-center text-red-700 mb-6">Cosas a tener en cuenta</p>
                                    <p>- Bluesky tiene límites de tasa de creación de 1,300 publicaciones, me gusta y republicaciones por hora y 11,000 por día.</p>
                                    <p>- Eliminar contenido cuenta como una publicación un me gusta o un repost.</p>
                                    <p>- Esta herramienta elimina hasta 4.000 registros por hora y 30.000 por día.</p>
                                    <p>- Aún deberías poder dar Me gusta, publicar o volver a publicar normalmente a menos que seas  <i>muy </i> activo.</p>
                                    <p>- Si comienzas a recibir errores relacionados con el "Límite de velocidad", puedes regresar y cancelar su trabajo.</p>
                                    <p className="text-lg text-center text-orange-600 mt-3">
                                        Esta herramienta ha eliminado {stats?.total_num_deleted.toLocaleString()} registros de {" "}
                                        {stats?.num_repos.toLocaleString()} cuentas
                                    </p>
                                </div>
                            </div>
                            ...
                            {resp && (
                                <div className="flex gap-2 justify-center">
                                    <div className="w-auto flex">
                                        <div className="max-w-xl text-sm text-gray-100">
                                            <p className="text-xl">
                                                Registros para eliminar: {resp.num_enqueued}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="mt-4 sm:ml-4 sm:flex-shrink-0 flex">
                                ...
                                >
                                    {loading === "delete" ? (
                                        ...
                                        <span className="whitespace-nowrap">Procesar</span>
                                    )}
                                </button>
                            </div>
                        </form>
                        <div>
                            <p className="mt-6 text-lg leading-6 text-gray-200 text-center">
                                Estado del proceso
                            </p>
                            <form
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 sm:flex-auto">
                                    <input
                                        ...
                                        id="jobID"
                                        className="peer relative col-start-1 row-start-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="ID del proceso existente"
                                        value={jobID}
                                ...
                                <div className="mt-3 sm:ml-4 sm:mt-0 sm:flex-shrink-0 flex">
                                    ...
                                    >
                                        {loading === "status" ? (
                                            ...
                                            <span className="whitespace-nowrap">Ver Estado</span>
                                        )}
                                    </button>
                                    <button
                                        onClick={async (e) =>
                                    ...
                                    >
                                        {loading === "cancel" ? (
                                            ...
                                            <span className="whitespace-nowrap">Cancelar proceso</span>
                                        )}
                                    </button>
                                </div>
                            </form>
